<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:119:"/Users/pan.liu/Documents/privateProject/familyMartOne/familymart1/public/../application/admin/view/cms/channel/add.html";i:1688437394;s:108:"/Users/pan.liu/Documents/privateProject/familyMartOne/familymart1/application/admin/view/layout/default.html";i:1688437394;s:105:"/Users/pan.liu/Documents/privateProject/familyMartOne/familymart1/application/admin/view/common/meta.html";i:1688437394;s:111:"/Users/pan.liu/Documents/privateProject/familyMartOne/familymart1/application/admin/view/cms/common/fields.html";i:1688437394;s:107:"/Users/pan.liu/Documents/privateProject/familyMartOne/familymart1/application/admin/view/common/script.html";i:1688437394;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select name="row[parent_id]" data-rule="required" id="parent_id" class="form-control">
                ...
                <option value="<?php echo $vo['id']; ?>" <?php if(input('parent_id')==$vo['id']): ?>selected <?php endif; if($vo['type']!=='link'): ?>data-model="<?php echo $vo['model_id']; ?>"<?php endif; ?>><?php echo $vo['name']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
